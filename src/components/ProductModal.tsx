    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md mx-auto p-0 bg-background">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="relative bg-white rounded-lg p-4" style={{
            background: `
              radial-gradient(circle at 0% 50%, transparent 12px, white 13px),
              radial-gradient(circle at 100% 50%, transparent 12px, white 13px),
              radial-gradient(circle at 50% 0%, transparent 12px, white 13px),
              radial-gradient(circle at 50% 100%, transparent 12px, white 13px)
            `,
            backgroundSize: '25px 25px, 25px 25px, 25px 25px, 25px 25px',
