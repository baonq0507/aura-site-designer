...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'history.profit': 'Profit',
     ...
     'order.rules.title': 'TERMS & REGULATIONS',
     'order.rules.subtitle': 'Please read the following rules and terms carefully before placing an order at Farfetch',
     'order.rules.order.title': 'Order Regulations',
     'order.rules.order.1': 'Customers must register an account and verify information before placing orders',
     'order.rules.order.2': 'Each order must have a minimum value of 100,000 VND',
     'order.rules.order.3': 'Order information must be accurate and complete',
     'order.rules.order.4': 'Prohibited or restricted products cannot be ordered',
     'order.rules.payment.title': 'Payment',
     'order.rules.payment.1': 'Payment via credit card, e-wallet and bank transfer supported',
     'order.rules.payment.2': 'Payment must be completed within 24 hours after placing order',
     'order.rules.payment.3': 'Orders will be automatically cancelled if not paid on time',
     'order.rules.payment.4': 'Refunds will be processed within 3-7 business days',
     'order.rules.processing.title': 'Processing Time',
     'order.rules.processing.1': 'Orders will be confirmed within 2 business hours',
     'order.rules.processing.2': 'Preparation time: 1-3 business days',
     'order.rules.processing.3': 'Delivery time: 2-5 business days depending on area',
     'order.rules.processing.4': 'Customers will receive notifications via email and SMS',
     'order.rules.delivery.title': 'Delivery & Returns',
     'order.rules.delivery.1': 'Free delivery for orders over 500,000 VND',
     'order.rules.delivery.2': 'Returns supported within 7 days from receipt',
     'order.rules.delivery.3': 'Returned products must be intact and unused',
     'order.rules.delivery.4': 'Return shipping costs will be borne by customers',
     'order.rules.contact.title': 'SUPPORT CONTACT',
     'order.rules.contact.subtitle': 'If you have questions about order rules, please contact us',
     'order.rules.contact.hotline': 'Hotline',
     'order.rules.contact.email': 'Email',
     'order.rules.contact.hours': 'Business Hours',
     'order.rules.contact.hours.value': '8:00 - 22:00 daily',
    ...
    'history.profit': '利润',
     ...
     'page.title.withdraw': '提取',
      'page.title.order.rules': '订单规则',
       ...
       // Order Rules page
       'order.rules.back': '返回',
       'order.rules.title': '条款和规定',
       'order.rules.subtitle': '在Farfetch下单前，请仔细阅读以下规则和条款',
       'order.rules.order.title': '订单规定',
       'order.rules.order.1': '客户在下单前必须注册账户并验证信息',
       'order.rules.order.2': '每个订单的最低价值为100,000越南盾',
       'order.rules.order.3': '订单信息必须准确完整',
       'order.rules.order.4': '不能订购禁止或限制的产品',
       'order.rules.payment.title': '付款',
       'order.rules.payment.1': '支持信用卡、电子钱包和银行转账付款',
       'order.rules.payment.2': '下单后24小时内必须完成付款',
       'order.rules.payment.3': '如未按时付款，订单将自动取消',
       'order.rules.payment.4': '退款将在3-7个工作日内处理',
       'order.rules.processing.title': '处理时间',
       'order.rules.processing.1': '订单将在2个工作小时内确认',
       'order.rules.processing.2': '准备时间：1-3个工作日',
       'order.rules.processing.3': '送货时间：根据地区2-5个工作日',
       'order.rules.processing.4': '客户将通过电子邮件和短信收到通知',
       'order.rules.delivery.title': '送货和退货',
       'order.rules.delivery.1': '订单超过500,000越南盾免费送货',
       'order.rules.delivery.2': '收货后7天内支持退货',
       'order.rules.delivery.3': '退货产品必须完好无损、未使用',
       'order.rules.delivery.4': '退货运费由客户承担',
       'order.rules.contact.title': '支持联系',
       'order.rules.contact.subtitle': '如果您对订单规则有疑问，请联系我们',
       'order.rules.contact.hotline': '热线',
       'order.rules.contact.email': '电子邮件',
       'order.rules.contact.hours': '营业时间',
       'order.rules.contact.hours.value': '每天8:00 - 22:00',
    ...
    'history.profit': '利益',
     ...
     'vip.benefits.priority.support.desc': 'カスタマーサービスチームから優先サポートを受ける',
      ...
      'page.title.withdraw': '出金',
       ...
       // Order Rules page
       'order.rules.back': '戻る',
       'order.rules.title': '利用規約・規定',
       'order.rules.subtitle': 'Farfetchでのご注文前に、以下のルールと利用規約をよくお読みください',
       'order.rules.order.title': '注文規定',
       'order.rules.order.1': 'ご注文前にアカウント登録と情報確認が必要です',
       'order.rules.order.2': '各注文の最低金額は100,000ベトナムドンです',
       'order.rules.order.3': '注文情報は正確かつ完全である必要があります',
       'order.rules.order.4': '禁止または制限された商品は注文できません',
       'order.rules.payment.title': '支払い',
       'order.rules.payment.1': 'クレジットカード、電子ウォレット、銀行振込での支払いをサポート',
       'order.rules.payment.2': '注文後24時間以内に支払いを完了する必要があります',
       'order.rules.payment.3': '期限内に支払いが行われない場合、注文は自動的にキャンセルされます',
       'order.rules.payment.4': '返金は3-7営業日以内に処理されます',
       'order.rules.processing.title': '処理時間',
       'order.rules.processing.1': '注文は2営業時間以内に確認されます',
       'order.rules.processing.2': '準備時間：1-3営業日',
       'order.rules.processing.3': '配送時間：地域により2-5営業日',
       'order.rules.processing.4': 'お客様にはメールとSMSで通知をお送りします',
       'order.rules.delivery.title': '配送・返品',
       'order.rules.delivery.1': '500,000ベトナムドン以上のご注文は送料無料',
       'order.rules.delivery.2': '商品受取から7日以内の返品をサポート',
       'order.rules.delivery.3': '返品商品は未開封・未使用である必要があります',
       'order.rules.delivery.4': '返品時の送料はお客様負担となります',
       'order.rules.contact.title': 'サポート連絡先',
       'order.rules.contact.subtitle': '注文ルールについてご質問がございましたら、お気軽にお問い合わせください',
       'order.rules.contact.hotline': 'ホットライン',
       'order.rules.contact.email': 'メール',
       'order.rules.contact.hours': '営業時間',
       'order.rules.contact.hours.value': '毎日8:00 - 22:00',
  ...
  vi: {
    ...
    'vip.benefits.priority.support.desc': 'Được ưu tiên hỗ trợ từ đội ngũ chăm sóc khách hàng',
     ...
     'page.title.withdraw': 'Rút tiền',
      ...
      'order.rules.title': 'ĐIỀU KHOẢN & QUY ĐỊNH',
      'order.rules.subtitle': 'Vui lòng đọc kỹ các quy tắc và điều khoản dưới đây trước khi thực hiện đặt hàng tại Farfetch',
      'order.rules.order.title': 'Quy định đặt hàng',
      'order.rules.order.1': 'Khách hàng phải đăng ký tài khoản và xác thực thông tin trước khi đặt hàng',
      'order.rules.order.2': 'Mỗi đơn hàng phải có giá trị tối thiểu 100,000 VNĐ',
      'order.rules.order.3': 'Thông tin đặt hàng phải chính xác và đầy đủ',
      'order.rules.order.4': 'Không được đặt hàng các sản phẩm bị cấm hoặc hạn chế',
      'order.rules.payment.title': 'Thanh toán',
      'order.rules.payment.1': 'Hỗ trợ thanh toán qua thẻ tín dụng, ví điện tử và chuyển khoản',
      'order.rules.payment.2': 'Thanh toán phải được thực hiện trong vòng 24 giờ sau khi đặt hàng',
      'order.rules.payment.3': 'Đơn hàng sẽ bị hủy tự động nếu không thanh toán đúng hạn',
      'order.rules.payment.4': 'Hoàn tiền sẽ được xử lý trong 3-7 ngày làm việc',
      'order.rules.processing.title': 'Thời gian xử lý',
      'order.rules.processing.1': 'Đơn hàng sẽ được xác nhận trong vòng 2 giờ làm việc',
      'order.rules.processing.2': 'Thời gian chuẩn bị hàng: 1-3 ngày làm việc',
      'order.rules.processing.3': 'Thời gian giao hàng: 2-5 ngày làm việc tùy theo khu vực',
      'order.rules.processing.4': 'Khách hàng sẽ nhận được thông báo qua email và SMS',
      'order.rules.delivery.title': 'Giao hàng & Đổi trả',
      'order.rules.delivery.1': 'Miễn phí giao hàng cho đơn hàng trên 500,000 VNĐ',
      'order.rules.delivery.2': 'Hỗ trợ đổi trả trong vòng 7 ngày kể từ khi nhận hàng',
      'order.rules.delivery.3': 'Sản phẩm đổi trả phải còn nguyên vẹn, chưa sử dụng',
      'order.rules.delivery.4': 'Chi phí giao hàng đổi trả sẽ do khách hàng chịu',
      'order.rules.contact.title': 'LIÊN HỆ HỖ TRỢ',
      'order.rules.contact.subtitle': 'Nếu bạn có thắc mắc về quy tắc đặt hàng, vui lòng liên hệ với chúng tôi',
      'order.rules.contact.hotline': 'Hotline',
      'order.rules.contact.email': 'Email',
      'order.rules.contact.hours': 'Giờ làm việc',
      'order.rules.contact.hours.value': '8:00 - 22:00 hàng ngày',
  ...
  th: {
    ...
    'page.title.withdraw': 'ถอน',
     ...
     'order.rules.title': 'ข้อกำหนดและเงื่อนไข',
     'order.rules.subtitle': 'กรุณาอ่านกฎและข้อกำหนดต่อไปนี้อย่างละเอียดก่อนทำการสั่งซื้อที่ Farfetch',
     'order.rules.order.title': 'ข้อกำหนดการสั่งซื้อ',
     'order.rules.order.1': 'ลูกค้าต้องลงทะเบียนบัญชีและยืนยันข้อมูลก่อนทำการสั่งซื้อ',
     'order.rules.order.2': 'แต่ละคำสั่งซื้อต้องมีมูลค่าขั้นต่ำ 100,000 VND',
     'order.rules.order.3': 'ข้อมูลการสั่งซื้อต้องถูกต้องและครบถ้วน',
     'order.rules.order.4': 'ไม่สามารถสั่งซื้อสินค้าที่ถูกห้ามหรือจำกัด',
     'order.rules.payment.title': 'การชำระเงิน',
     'order.rules.payment.1': 'รองรับการชำระเงินผ่านบัตรเครดิต กระเป๋าอิเล็กทรอนิกส์ และการโอนเงิน',
     'order.rules.payment.2': 'การชำระเงินต้องเสร็จสิ้นภายใน 24 ชั่วโมงหลังจากสั่งซื้อ',
     'order.rules.payment.3': 'คำสั่งซื้อจะถูกยกเลิกโดยอัตโนมัติหากไม่ชำระเงินตามกำหนด',
     'order.rules.payment.4': 'การคืนเงินจะดำเนินการภายใน 3-7 วันทำการ',
     'order.rules.processing.title': 'เวลาในการดำเนินการ',
     'order.rules.processing.1': 'คำสั่งซื้อจะได้รับการยืนยันภายใน 2 ชั่วโมงทำการ',
     'order.rules.processing.2': 'เวลาในการเตรียมสินค้า: 1-3 วันทำการ',
     'order.rules.processing.3': 'เวลาในการจัดส่ง: 2-5 วันทำการขึ้นอยู่กับพื้นที่',
     'order.rules.processing.4': 'ลูกค้าจะได้รับการแจ้งเตือนผ่านอีเมลและ SMS',
     'order.rules.delivery.title': 'การจัดส่งและการส่งคืน',
     'order.rules.delivery.1': 'จัดส่งฟรีสำหรับคำสั่งซื้อเกิน 500,000 VND',
     'order.rules.delivery.2': 'รองรับการส่งคืนภายใน 7 วันนับจากวันที่ได้รับ',
     'order.rules.delivery.3': 'สินค้าที่ส่งคืนต้องยังคงสภาพเดิมและยังไม่ได้ใช้',
     'order.rules.delivery.4': 'ค่าจัดส่งสำหรับการส่งคืนจะเป็นความรับผิดชอบของลูกค้า',
     'order.rules.contact.title': 'ติดต่อสนับสนุน',
     'order.rules.contact.subtitle': 'หากคุณมีคำถามเกี่ยวกับกฎการสั่งซื้อ กรุณาติดต่อเรา',
     'order.rules.contact.hotline': 'สายด่วน',
     'order.rules.contact.email': 'อีเมล',
     'order.rules.contact.hours': 'เวลาทำการ',
     'order.rules.contact.hours.value': '8:00 - 22:00 ทุกวัน',
  ...
  ko: {
    ...
    'page.title.withdraw': '출금',
     ...
     // Order Rules page
     'order.rules.back': '뒤로',
     'order.rules.title': '약관 및 규정',
     'order.rules.subtitle': 'Farfetch에서 주문하기 전에 다음 규칙과 약관을 주의 깊게 읽어보세요',
     'order.rules.order.title': '주문 규정',
     'order.rules.order.1': '고객은 주문 전에 계정을 등록하고 정보를 확인해야 합니다',
     'order.rules.order.2': '각 주문은 최소 100,000 VND의 가치를 가져야 합니다',
     'order.rules.order.3': '주문 정보는 정확하고 완전해야 합니다',
     'order.rules.order.4': '금지되거나 제한된 제품은 주문할 수 없습니다',
     'order.rules.payment.title': '결제',
     'order.rules.payment.1': '신용카드, 전자지갑 및 은행 이체를 통한 결제 지원',
     'order.rules.payment.2': '주문 후 24시간 이내에 결제를 완료해야 합니다',
     'order.rules.payment.3': '시간 내에 결제하지 않으면 주문이 자동으로 취소됩니다',
     'order.rules.payment.4': '환불은 3-7 영업일 이내에 처리됩니다',
     'order.rules.processing.title': '처리 시간',
     'order.rules.processing.1': '주문은 2 영업시간 이내에 확인됩니다',
     'order.rules.processing.2': '준비 시간: 1-3 영업일',
     'order.rules.processing.3': '배송 시간: 지역에 따라 2-5 영업일',
     'order.rules.processing.4': '고객은 이메일과 SMS를 통해 알림을 받습니다',
     'order.rules.delivery.title': '배송 및 반품',
     'order.rules.delivery.1': '500,000 VND 이상 주문 시 무료 배송',
     'order.rules.delivery.2': '수령 후 7일 이내 반품 지원',
     'order.rules.delivery.3': '반품 제품은 완전하고 사용되지 않은 상태여야 합니다',
     'order.rules.delivery.4': '반품 배송비는 고객이 부담합니다',
     'order.rules.contact.title': '지원 연락처',
     'order.rules.contact.subtitle': '주문 규칙에 대한 질문이 있으시면 연락해 주세요',
     'order.rules.contact.hotline': '핫라인',
     'order.rules.contact.email': '이메일',
     'order.rules.contact.hours': '영업 시간',
     'order.rules.contact.hours.value': '매일 8:00 - 22:00',
