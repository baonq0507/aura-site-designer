  ...
  en: {
    ...
    'history.profit': 'Profit',
     ...
     'order.rules.delivery.4': 'Platform reserves the right to modify these rules at any time',
      ...
      'auth.login.identifier.placeholder': 'Enter email, username or phone number',
      'auth.login.identifier.hint': 'You can sign in with email, username or phone number',
  ...
  zh: {
    ...
    'history.profit': '利润',
     ...
     'page.title.language': '语言',
      ...
      'auth.login.identifier.placeholder': '输入邮箱、用户名或手机号',
      'auth.login.identifier.hint': '您可以使用邮箱、用户名或手机号登录',
  ...
  vi: {
    ...
    'vip.benefits.priority.support.desc': 'Được ưu tiên hỗ trợ từ đội ngũ chăm sóc khách hàng',
     ...
     'page.title.vip.levels': 'Cấp độ VIP',
      ...
      'auth.login.identifier.placeholder': 'Nhập email, tên người dùng hoặc số điện thoại',
      'auth.login.identifier.hint': 'Bạn có thể đăng nhập bằng email, tên người dùng hoặc số điện thoại',
