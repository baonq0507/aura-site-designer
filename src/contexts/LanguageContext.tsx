...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'history.filter.thisMonth': 'This Month',
     ...
     // Order Rules page
     'order.rules.back': 'BACK',
     'order.rules.title': 'Order Rules',
     'order.rules.subtitle': 'Platform operating rules and guidelines',
     'order.rules.order.title': 'Platform Operating Rules',
     'order.rules.order.1': 'This platform adopts an artificial intelligence system to serve merchants and order-grabbing users more conveniently and quickly',
     'order.rules.order.2': 'This platform serves more than 100,000 e-commerce merchants around the world who cooperate with SPECIAL NOTICE. The merchants display and sell their products on this platform to increase the exposure of their products. After the order grabbing user completes the order, the merchant will immediately return the order amount and commission. The platform randomly matches merchants or orders for order grabbing users, and the commission is related to the order size and VIP level',
     'order.rules.order.3': 'The number of orders is related to the VIP level. The higher the VIP level, the greater the number of orders and the higher the profit',
     'order.rules.order.4': 'The platform system will determine the VIP level based on the user\'s account balance and upgrade/downgrade the level for the order grabbing user',
     'order.rules.payment.title': 'Order Completion Rules',
     'order.rules.payment.1': 'The order grabbing user can only complete the order quantity of the corresponding VIP level once a day. The order grabbing user can only withdraw cash after completing the order quantity of the corresponding VIP level',
     'order.rules.payment.2': 'After completing the order of the day, if the user still wants to continue to earn commissions, he can choose to increase the VIP level. Or wait for the system reset order the next day',
     'order.rules.payment.3': 'In order to encourage users to grab orders, the platform has set up lucky orders, and the lucky orders are randomly matched',
     'order.rules.payment.4': 'This platform adopts a membership invitation system. Users who grab orders can invite relatives and friends to participate in the order grab',
     'order.rules.processing.title': 'Privacy Policy',
     'order.rules.processing.1': 'The SPECIAL NOTICE platform respects the privacy of every order-grabbing user and pays more attention to protecting the privacy of order-grabbing users',
     'order.rules.processing.2': 'All user data is encrypted and stored securely on our servers',
     'order.rules.processing.3': 'We do not share personal information with third parties without explicit consent',
     'order.rules.processing.4': 'Users have the right to request deletion of their personal data at any time',
     'order.rules.delivery.title': 'Final Terms',
     'order.rules.delivery.1': 'The above SPECIAL NOTICE platform has the final right of interpretation',
     'order.rules.delivery.2': 'Users are kindly requested to abide by the rules',
     'order.rules.delivery.3': 'Any violation of platform rules may result in account suspension',
     'order.rules.delivery.4': 'Platform reserves the right to modify these rules at any time',
      'page.title.about.us': 'About Us',
      'page.title.delivery.info': 'Delivery Information',
      
      // Platform Introduction
      'platform.intro.title': 'About Farfetch Limited',
      'platform.intro.paragraph1': 'Farfetch Limited is a global e-commerce platform specializing in luxury fashion, founded in 2007 by Portuguese entrepreneur José Neves in London, UK. The platform officially launched in 2008 with the mission to connect independent fashion boutiques with customers worldwide through a modern, personalized, and convenient digital platform.',
      'platform.intro.paragraph2': 'To date, Farfetch operates in over 190 countries and territories, partnering with approximately 1,300–1,400 brands, boutiques, and luxury department stores across more than 50 countries. The platform offers thousands of luxury fashion products while providing a modern shopping experience integrated with advanced technology and personalized user behavior customization.',
      'platform.intro.paragraph3': 'Farfetch operates on a marketplace model, allowing buyers to access a diverse range of products without holding inventory. However, high operating costs and recent financial fluctuations have posed significant challenges to the company. At the end of 2023, Farfetch received a rescue investment from Coupang — South Korea\'s largest e-commerce corporation — to sustain operations and restructure its system.',
      'platform.intro.paragraph4': 'To foster sustainable growth, Farfetch provides long-term employees and members the opportunity to invest, distribute orders, and earn profits through their own storefronts. The storefront system is tiered into VIP levels, from small to large, facilitating investors of various scales to participate and grow alongside the platform.',
      'platform.intro.us.offices.title': 'Farfetch Offices in the United States',
      'platform.intro.los.angeles': 'Los Angeles',
      'platform.intro.los.angeles.subtitle': 'West Coast / U.S. West Coast HQ',
      'platform.intro.legal.entity': 'Legal entity name',
      'platform.intro.address': 'Address',
      'platform.intro.new.york': 'New York City',
      'platform.intro.office.location': 'Office location',
      'platform.intro.near.landmarks': 'near Bryant Park and Grand Central Terminal',
      'page.title.bank.linking': 'Bank Linking',
      
      // Bank Linking
      'bank.linking.title': 'Bank Linking',
      'bank.linking.add': 'Add',
      'bank.linking.add.account': 'Add Bank Account',
      'bank.linking.select.bank': 'Select Bank',
      'bank.linking.account.number': 'Account Number',
      'bank.linking.account.number.placeholder': 'Enter account number',
      'bank.linking.account.holder': 'Account Holder',
      'bank.linking.account.holder.placeholder': 'Account holder name',
      'bank.linking.branch': 'Branch',
      'bank.linking.branch.placeholder': 'Enter branch (optional)',
      'bank.linking.add.account.button': 'Add Account',
      'bank.linking.cancel': 'Cancel',
      'bank.linking.no.accounts': 'No bank accounts linked yet',
      'bank.linking.no.accounts.desc': 'Add your first bank account to start using withdrawal services',
      'bank.linking.add.first': 'Add First Account',
      'bank.linking.account.details': 'Account Details',
      'bank.linking.account.added': 'Bank account added successfully',
      'bank.linking.account.updated': 'Bank account updated successfully',
      'bank.linking.account.deleted': 'Bank account deleted successfully',
      'bank.linking.delete.confirm': 'Delete Confirmation',
      ...
      'withdrawal.page.title': 'Withdrawal History',
      'withdrawal.loading': 'Loading...',
      'withdrawal.no.transactions': 'No withdrawal transactions yet',
      ...
      'withdrawal.date.created': 'Created Date:',
      'withdrawal.date.processed': 'Processed Date:',
      'withdrawal.notes': 'Notes:',
      'withdrawal.error.load': 'Unable to load withdrawal history',
      'support.initial.message': 'Hello, I need support!',
      'delivery.page.title': 'Delivery Information',
      'delivery.address.title': 'Delivery Address',
      'delivery.full.name': 'Full Name',
      'delivery.full.name.placeholder': 'Enter full name',
      'delivery.phone.number': 'Phone Number',
      'delivery.phone.number.placeholder': 'Enter phone number',
      'delivery.city': 'Province/City',
      'delivery.city.placeholder': 'Province/City',
      'delivery.district': 'District',
      'delivery.district.placeholder': 'District',
      'delivery.ward': 'Ward',
      'delivery.ward.placeholder': 'Ward',
      'delivery.address': 'Specific Address',
      'delivery.address.placeholder': 'House number, street name...',
      'delivery.save': 'Save Information',
      'delivery.saving': 'Saving...',
      'delivery.success': 'Success',
      'delivery.success.message': 'Delivery information saved',
      'delivery.error': 'Error',
      'delivery.error.message': 'Could not save delivery information',
      ...
      'auth.phone.placeholder': '+15555551234',
      ...
      'auth.login.identifier': 'Email, Username or Phone',
      'auth.login.identifier.placeholder': 'Enter username or phone number',
      'auth.login.identifier.hint': 'You can sign in with username or phone number',
      'auth.signin.failed': 'Sign in failed',
      'auth.signin.invalid.credentials': 'Username/phone or password is incorrect',
      'auth.signin.user.not.found': 'User not found with this information',
      'auth.signin.success': 'Sign in successful',
      'auth.signin.welcome.back': 'Welcome back!',
      'auth.signin.welcome': 'Welcome to the platform!',
      ...
      'auth.signup.success.message': 'Account created successfully! You are now logged in.',
      ...
      'admin.vip.users': 'VIP Users',
      'admin.special.roles': 'Users with special roles',
      'admin.total.orders': 'Total Orders',
      'admin.all.time.orders': 'All time orders',
      'admin.total.revenue': 'Total Revenue',
      'admin.completed.orders': 'From completed orders',
      'admin.net.revenue': 'Deposits - Withdrawals',
      'admin.total.deposits': 'Total Deposits',
      'admin.user.deposits': 'From all user deposits',
      'admin.total.withdrawals': 'Total Withdrawals',
      'admin.completed.withdrawals': 'From completed withdrawals',
      ...
      'admin.select.vip.level': 'Select VIP Level',
      'admin.withdrawal.management': 'Withdrawal Management',
      'admin.deposit.history': 'Deposit History',
      'admin.search.users': 'Search by username, email, or phone...',
      'admin.all.status': 'All Status',
      'admin.active': 'Active',
      'admin.locked': 'Locked',
      ...
      'admin.phone': 'Phone',
      'admin.role': 'Role',
      'admin.vip.level': 'VIP Level',
      'admin.total.spent': 'Total Spent',
      'admin.balance': 'Balance',
      'admin.bonus.orders': 'Bonus Orders',
      'admin.bonus.amount': 'Bonus Amount',
      'admin.account.status': 'Account Status',
      'admin.task.status': 'Task Status',
      ...
      'admin.saving': 'Saving...',
      'admin.cancel': 'Cancel',
      'admin.no.users.found': 'No users found matching the current filters',
      'admin.no.username': 'No username',
      'admin.no.email': 'No email',
      'admin.no.phone': 'No phone',
      'admin.users.count': 'Users',
      'admin.user.updated': 'User updated successfully',
      'admin.user.update.failed': 'Failed to update user',
      'admin.role.updated': 'User role updated successfully',
      'admin.role.update.failed': 'Failed to update user role',
      'admin.vip.add.new': 'Add New Level',
      'admin.level.id': 'Level ID',
      'admin.image': 'Image',
      'admin.level.name': 'Level Name',
      'admin.min.orders': 'Min Orders',
      'admin.min.spent': 'Min Spent',
      'admin.commission.rate': 'Commission Rate (%)',
      'admin.created.date': 'Created Date',
      'admin.new': 'New',
      'admin.add': 'Add',
      'admin.bank.info': 'Bank Information',
      ...
      'admin.stock': 'Stock',
      'admin.no.image': 'No Image',
      'admin.no.description': 'No description',
      'admin.date': 'Date',
    ...
    'task.error.system.disabled': 'System has stopped operating, please come back tomorrow.',
      ...
      'admin.purchase.revenue': 'Total Revenue',
      'admin.purchase.avg.value': 'Average Order Value',
      'admin.per.order': 'per order',
      'admin.vip.customers': 'VIP Customers',
      'admin.purchase.customers': 'total customers',
      'admin.bestselling.products': 'Bestselling Products',
      'admin.products.sold': 'products sold',
      'admin.customers.tab': 'Customers',
      'admin.top.products': 'Top 10 Bestselling Products',
      'admin.customer.list': 'Customer List',
      'admin.search.customer': 'Search by name, email, phone...',
      'admin.sort.by': 'Sort by',
      'admin.highest.spending': 'Highest Spending',
      'admin.most.orders': 'Most Orders',
      'admin.recent.purchase': 'Recent Purchase',
      'admin.filter.vip': 'Filter VIP',
      'admin.vip.only': 'VIP Only',
      'admin.regular.customers': 'Regular Customers',
      'admin.purchase.orders': 'Total Orders',
      'admin.purchase.spending': 'Total Spending',
      'admin.average.value': 'Average Value',
      'admin.last.purchase': 'Last Purchase',
      'admin.purchase.action': 'Action',
      'admin.view.details': 'View Details',
      'admin.quantity.sold': 'Quantity Sold',
      'admin.order.count': 'Order Count',
      'admin.customer.details': 'Customer Details',
      'admin.recent.orders': 'Recent Orders',
      'admin.no.orders.yet': 'No orders yet',
      'admin.no.customers.found': 'No customers found',
      'admin.no.customer.data': 'No customer data yet',
      
      // Order Management  
      'admin.order.management': 'Order Management',
      'admin.order.overview': 'View and manage all customer orders',
      'admin.pending.orders': 'Pending Orders',
      'admin.order.list': 'Order List',
      'admin.search.order': 'Search by ID, product, customer name...',
      'admin.filter.status': 'Filter by Status',
      'admin.order.id': 'Order ID',
      'admin.order.product': 'Product',
      'admin.order.quantity': 'Quantity',
      'admin.order.amount': 'Total Amount',
      'admin.order.created': 'Created Date',
      ...
      'admin.product.info': 'Product Information',
    ...
    'admin.system.management': 'System Management',
      ...
      'admin.chat.response.time': 'Avg Response Time',
      'admin.chat.minutes': 'minutes',
      'admin.chat.open': 'Open Chats',
      'admin.chat.list': 'Chat List',
      'admin.filter.chat.status': 'Filter by Status',
      'admin.chat.status.open': 'Open',
      'admin.chat.status.closed': 'Closed',
      'admin.chat.status.resolved': 'Resolved',
      'admin.chat.title': 'Chat Title',
      'admin.chat.last.message': 'Last Message',
      'admin.chat.unread.count': 'Unread',
      'admin.chat.status': 'Status',
      'admin.chat.created': 'Created',
      'admin.chat.select': 'Select a chat to view messages',
      'admin.chat.type.message': 'Type your message...',
      'admin.chat.send': 'Send',
      'admin.chat.attach.file': 'Attach File',
      'admin.chat.message.sent': 'Message sent successfully',
      'admin.chat.failed.send': 'Failed to send message',
      'admin.chat.failed.load.chats': 'Failed to load chat list',
      'admin.chat.failed.load.messages': 'Failed to load messages',
      'admin.chat.no.chats.found': 'No chats found',
      'admin.chat.no.chats.yet': 'No chats yet',
      'admin.chat.no.messages': 'No messages in this chat yet',
      'admin.chat.file.size.limit': 'File size must be less than 10MB',
      'admin.chat.uploading': 'Uploading file...',
      'admin.chat.failed.upload': 'Failed to upload file'
    },
  zh: {
    // Navigation
    'nav.home': '首页',
    ...
    'profile.delivery.info': '收货信息',
      ...
      // Bank Linking
      'bank.linking.title': '银行绑定',
      'bank.linking.add': '添加',
      'bank.linking.add.account': '添加银行账户',
      'bank.linking.select.bank': '选择银行',
      'bank.linking.account.number': '账户号码',
      'bank.linking.account.number.placeholder': '输入账户号码',
      'bank.linking.account.holder': '账户持有人',
      'bank.linking.account.holder.placeholder': '账户持有人姓名',
      'bank.linking.branch': '分行',
      'bank.linking.branch.placeholder': '输入分行（可选）',
      'bank.linking.add.account.button': '添加账户',
      'bank.linking.cancel': '取消',
      'bank.linking.no.accounts': '尚未绑定银行账户',
      'bank.linking.no.accounts.desc': '添加您的第一个银行账户以开始使用提取服务',
      'bank.linking.add.first': '添加第一个账户',
      'bank.linking.account.details': '账户详情',
      'bank.linking.account.added': '银行账户添加成功',
      'bank.linking.account.updated': '银行账户更新成功',
      'bank.linking.account.deleted': '银行账户删除成功',
      'bank.linking.delete.confirm': '删除确认',
      'bank.linking.delete.warning': '您确定要删除此银行账户吗？此操作无法撤销。',
      'bank.linking.adding': '添加中...',
      'bank.linking.error.fill.required': '请填写所有必填字段',
      'common.success': '成功',
    ...
    'history.filter.thisMonth': '本月',
     ...
     'page.title.withdraw': '提取',
      'page.title.order.rules': '订单规则',
       'page.title.platform.intro': '平台介绍',
        ...
        // Order Rules page
        'order.rules.back': '返回',
        'order.rules.title': '订单规则',
        'order.rules.subtitle': '平台运营规则和指导原则',
        'order.rules.order.title': '平台运营规则',
        'order.rules.order.1': '本平台采用人工智能系统，更便捷快速地为商户和抢单用户提供服务',
        'order.rules.order.2': '本平台为全球超过10万家与SPECIAL NOTICE合作的电商商户提供服务。商户在本平台展示和销售其产品，以增加产品曝光度。抢单用户完成订单后，商户将立即返还订单金额和佣金。平台为抢单用户随机匹配商户或订单，佣金与订单大小和VIP等级相关',
        'order.rules.order.3': '订单数量与VIP等级相关。VIP等级越高，订单数量越多，利润越高',
        'order.rules.order.4': '平台系统将根据用户的账户余额确定VIP等级，并为抢单用户升级/降级等级',
        'order.rules.payment.title': '订单完成规则',
        'order.rules.payment.1': '抢单用户每天只能完成对应VIP等级的订单数量。抢单用户只有在完成对应VIP等级的订单数量后才能提现',
        'order.rules.payment.2': '完成当天订单后，如果用户仍想继续赚取佣金，可以选择提高VIP等级。或等待第二天系统重置订单',
        'order.rules.payment.3': '为了鼓励用户抢单，平台设置了幸运订单，幸运订单是随机匹配的',
        'order.rules.payment.4': '本平台采用会员邀请制。抢单用户可以邀请亲友参与抢单',
        'order.rules.processing.title': '隐私政策',
        'order.rules.processing.1': 'SPECIAL NOTICE平台尊重每位抢单用户的隐私，更加注重保护抢单用户的隐私',
        'order.rules.processing.2': '所有用户数据均经过加密并安全存储在我们的服务器上',
        'order.rules.processing.3': '未经明确同意，我们不会与第三方分享个人信息',
        'order.rules.processing.4': '用户有权随时要求删除其个人数据',
        'order.rules.delivery.title': '最终条款',
        'order.rules.delivery.1': '以上SPECIAL NOTICE平台拥有最终解释权',
        'order.rules.delivery.2': '敬请用户遵守规则',
        'order.rules.delivery.3': '任何违反平台规则的行为可能导致账户暂停',
        'order.rules.delivery.4': '平台保留随时修改这些规则的权利',
      'page.title.about.us': '关于我们',
      'page.title.delivery.info': '配送信息',
      'page.title.bank.linking': '银行绑定',
      
      // Platform Introduction
      'platform.intro.title': '关于Farfetch Limited',
      'platform.intro.paragraph1': 'Farfetch Limited是一个专门从事奢侈时尚的全球电子商务平台，由葡萄牙企业家José Neves于2007年在英国伦敦创立。该平台于2008年正式启动，使命是通过现代、个性化和便捷的数字平台将独立时尚精品店与全球客户连接起来。',
      'platform.intro.paragraph2': '至今，Farfetch已在190多个国家和地区运营，与约1,300-1,400个品牌、精品店和50多个国家的奢侈品百货商店合作。该平台提供数千种奢侈时尚产品，同时提供融合先进技术和基于用户行为个性化定制的现代购物体验。',
      'platform.intro.paragraph3': 'Farfetch采用市场模式运营，允许买家在不持有库存的情况下获得多样化的产品。然而，高运营成本和最近的财务波动给公司带来了巨大挑战。2023年底，Farfetch获得了韩国最大电子商务公司Coupang的救助投资，以维持运营并重组系统。',
      'platform.intro.paragraph4': '为了促进可持续增长，Farfetch为长期员工和会员提供投资、分配订单并通过自己的店面获得利润的机会。店面系统分为从小到大的VIP级别，为不同规模的投资者提供便利，使其能够参与并与平台共同成长。',
      'platform.intro.us.offices.title': 'Farfetch在美国的办事处',
      'platform.intro.los.angeles': '洛杉矶',
      'platform.intro.los.angeles.subtitle': '西海岸/美国西海岸总部',
      'platform.intro.legal.entity': '法律实体名称',
      'platform.intro.address': '地址',
      'platform.intro.new.york': '纽约市',
      'platform.intro.office.location': '办公地点',
      'platform.intro.near.landmarks': '靠近布莱恩特公园和中央车站',
     ...
     'page.title.language': '语言',
      ...
      'withdrawal.page.title': '提取历史',
      'withdrawal.loading': '加载中...',
      'withdrawal.no.transactions': '暂无提取交易记录',
      'withdrawal.amount': '提取',
      'withdrawal.status.pending': '待处理',
      'withdrawal.status.approved': '已批准',
      'withdrawal.status.completed': '已完成',
      'withdrawal.status.rejected': '已拒绝',
      'withdrawal.date.created': '创建日期:',
      'withdrawal.date.processed': '处理日期:',
      'withdrawal.notes': '备注:',
      'withdrawal.error.load': '无法加载提取历史',
      'delivery.page.title': '收货信息',
      'delivery.address.title': '收货地址',
      'delivery.full.name': '姓名',
      'delivery.full.name.placeholder': '请输入姓名',
      'delivery.phone.number': '电话号码',
      'delivery.phone.number.placeholder': '请输入电话号码',
      'delivery.city': '省/市',
      'delivery.city.placeholder': '省/市',
      'delivery.district': '区/县',
      'delivery.district.placeholder': '区/县',
      'delivery.ward': '街道/镇',
      'delivery.ward.placeholder': '街道/镇',
      'delivery.address': '详细地址',
      'delivery.address.placeholder': '门牌号，街道名...',
      'delivery.save': '保存信息',
      'delivery.saving': '保存中...',
      'delivery.success': '成功',
      'delivery.success.message': '收货信息已保存',
      'delivery.error': '错误',
      'delivery.error.message': '无法保存收货信息',
      ...
      'auth.invitation.code': '邀请码',
      'auth.invitation.code.optional': '邀请码（可选）',
      'auth.invitation.code.placeholder': '输入邀请码',
      'auth.agree.with': '我同意',
      'auth.terms.of.service': '服务条款',
      'auth.login.identifier': '邮箱、用户名或手机号',
      'auth.login.identifier.placeholder': '输入用户名或手机号',
      'auth.login.identifier.hint': '您可以使用用户名或手机号登录',
      'auth.signin.failed': '登录失败',
      'auth.signin.invalid.credentials': '用户名/手机号或密码错误',
      'auth.signin.user.not.found': '未找到此用户信息',
      'auth.signin.success': '登录成功',
      'auth.signin.welcome.back': '欢迎回来！',
      'auth.signin.welcome': '欢迎使用平台！',
      'auth.signin.error': '登录时发生错误',
      'auth.signup.failed': '注册失败',
      'auth.signup.fill.all.fields': '请填写所有必填字段',
      'auth.signup.success': '注册成功',
      'auth.signup.success.message': '账户创建成功！您现在已登录。',
      ...
      'admin.registered.users': '注册用户',
      'admin.vip.users': 'VIP用户',
      'admin.special.roles': '拥有特殊角色的用户',
      'admin.total.orders': '总订单数',
      'admin.all.time.orders': '所有订单',
      'admin.total.revenue': '总收入',
      'admin.completed.orders': '来自已完成的订单',
      'admin.net.revenue': '存款 - 提取',
      'admin.total.deposits': '总存款',
      'admin.user.deposits': '来自所有用户存款',
      'admin.total.withdrawals': '总提取',
      'admin.completed.withdrawals': '来自已完成的提取',
      'admin.user.management': '用户管理',
      'admin.vip.management': 'VIP管理',
      'admin.product.management': '产品管理',
      'admin.add.product': '添加产品',
      'admin.create.new.product': '创建新产品',
      'admin.product.name': '产品名称',
      'admin.product.image': '产品图片',
      'admin.create.product': '创建产品',
      'admin.select.vip.level': '选择VIP等级',
      'admin.withdrawal.management': '提现管理',
      'admin.deposit.history': '充值历史',
      'admin.search.users': '按用户名、邮箱或电话搜索...',
      'admin.all.status': '所有状态',
      'admin.active': '活跃',
      'admin.locked': '锁定',
      'admin.all.roles': '所有角色',
      'admin.admin.role': '管理员',
      'admin.moderator.role': '版主',
      'admin.user.role': '用户',
      'admin.cards': '卡片',
      'admin.table': '表格',
      'admin.username': '用户名',
      ...
      'admin.phone': '电话',
      'admin.role': '角色',
      'admin.vip.level': 'VIP等级',
      'admin.total.spent': '总消费',
      'admin.balance': '余额',
      'admin.bonus.orders': '奖励订单',
      'admin.bonus.amount': '奖励金额',
      'admin.account.status': '账户状态',
      'admin.task.status': '任务状态',
      'admin.actions': '操作',
      'admin.edit': '编辑',
      'admin.edit.user': '编辑用户',
      'admin.save.changes': '保存更改',
      'admin.saving': '保存中...',
      'admin.cancel': '取消',
      'admin.no.users.found': '没有找到匹配当前筛选条件的用户',
      'admin.no.username': '无用户名',
      'admin.no.email': '无邮箱',
      'admin.no.phone': '无电话',
      'admin.users.count': '用户',
      'admin.user.updated': '用户更新成功',
      'admin.user.update.failed': '用户更新失败',
      'admin.role.updated': '用户角色更新成功',
      'admin.role.update.failed': '用户角色更新失败',
      'admin.vip.add.new': '添加新等级',
      'admin.level.id': '等级编号',
      'admin.image': '图片',
      'admin.level.name': '等级名称',
      'admin.min.orders': '最小订单数',
      'admin.min.spent': '最小消费',
      'admin.commission.rate': '佣金率（%）',
      'admin.created.date': '创建日期',
      'admin.new': '新建',
      'admin.add': '添加',
    ...
    'task.error.system.disabled': '系统已停止运行，请明天再来',
      ...
      // User Purchase Management
      'admin.purchase.management': '用户购买管理',
      'admin.purchase.analysis': '分析和管理客户购买活动',
      'admin.purchase.revenue': '总收入',
      'admin.purchase.avg.value': '平均订单价值',
      'admin.per.order': '每订单',
      'admin.vip.customers': 'VIP客户',
      'admin.purchase.customers': '总客户',
      'admin.bestselling.products': '畅销产品',
      'admin.products.sold': '产品已售',
      'admin.customers.tab': '客户',
      'admin.top.products': '前10畅销产品',
      'admin.customer.list': '客户列表',
      'admin.search.customer': '按姓名、邮箱、电话搜索...',
      'admin.sort.by': '排序方式',
      'admin.highest.spending': '最高消费',
      'admin.most.orders': '最多订单',
      'admin.recent.purchase': '最近购买',
      'admin.filter.vip': '筛选VIP',
      'admin.vip.only': '仅VIP',
      'admin.regular.customers': '普通客户',
      'admin.purchase.orders': '总订单',
      'admin.purchase.spending': '总消费',
      'admin.average.value': '平均价值',
      'admin.last.purchase': '最后购买',
      'admin.purchase.action': '操作',
      'admin.view.details': '查看详情',
      'admin.quantity.sold': '销售数量',
      'admin.order.count': '订单数量',
      'admin.customer.details': '客户详情',
      'admin.recent.orders': '最近订单',
      'admin.no.orders.yet': '暂无订单',
      'admin.no.customers.found': '未找到客户',
      'admin.no.customer.data': '暂无客户数据',
      
      // Order Management
      'admin.order.management': '订单管理',
      'admin.order.overview': '查看和管理所有客户订单',
      'admin.pending.orders': '待处理订单',
      'admin.order.list': '订单列表',
      'admin.search.order': '按ID、产品、客户名称搜索...',
      'admin.filter.status': '按状态筛选',
      'admin.order.id': '订单ID',
      'admin.order.product': '产品',
      'admin.order.quantity': '数量',
      'admin.order.amount': '总金额',
      'admin.order.created': '创建日期',
      'admin.order.details': '订单详情',
      'admin.order.status': '订单状态',
      'admin.update.status': '更新状态',
      'admin.customer.info': '客户信息',
      'admin.product.info': '产品信息',
    ...
    'admin.system.management': '系统管理',
      ...
      'admin.chat.response.time': '平均响应时间',
      'admin.chat.minutes': '分钟',
      'admin.chat.open': '打开聊天',
      'admin.chat.list': '聊天列表',
      'admin.filter.chat.status': '按状态筛选',
      'admin.chat.status.open': '打开',
      'admin.chat.status.closed': '关闭',
      'admin.chat.status.resolved': '已解决',
      'admin.chat.title': '聊天标题',
      'admin.chat.last.message': '最后消息',
      'admin.chat.unread.count': '未读',
      'admin.chat.status': '状态',
      'admin.chat.created': '创建',
      'admin.chat.select': '选择聊天查看消息',
      'admin.chat.type.message': '输入您的消息...',
      'admin.chat.send': '发送',
      'admin.chat.attach.file': '附加文件',
      'admin.chat.message.sent': '消息发送成功',
      'admin.chat.failed.send': '发送消息失败',
      'admin.chat.failed.load.chats': '加载聊天列表失败',
      'admin.chat.failed.load.messages': '加载消息失败',
      'admin.chat.no.chats.found': '未找到聊天',
      'admin.chat.no.chats.yet': '暂无聊天',
      'admin.chat.no.messages': '此聊天中暂无消息',
      'admin.chat.file.size.limit': '文件大小必须小于10MB',
      'admin.chat.uploading': '上传文件中...',
      'admin.chat.failed.upload': '上传文件失败'
    },
  ja: {
    // Navigation
    'nav.home': 'ホーム',
    ...
    // Bank Linking
    'bank.linking.title': '銀行連携',
    'bank.linking.add': '追加',
    'bank.linking.add.account': '銀行口座を追加',
    'bank.linking.select.bank': '銀行を選択',
    'bank.linking.account.number': '口座番号',
    'bank.linking.account.number.placeholder': '口座番号を入力',
    'bank.linking.account.holder': '口座名義人',
    'bank.linking.account.holder.placeholder': '口座名義人名',
    'bank.linking.branch': '支店',
    'bank.linking.branch.placeholder': '支店を入力（任意）',
    'bank.linking.add.account.button': '口座を追加',
    'bank.linking.cancel': 'キャンセル',
    'bank.linking.no.accounts': 'まだ銀行口座が連携されていません',
    'bank.linking.no.accounts.desc': '出金サービスの利用を開始するために最初の銀行口座を追加してください',
    'bank.linking.add.first': '最初の口座を追加',
    'bank.linking.account.details': '口座詳細',
    'bank.linking.account.added': '銀行口座が正常に追加されました',
    'bank.linking.account.updated': '銀行口座が正常に更新されました',
    'bank.linking.account.deleted': '銀行口座が正常に削除されました',
    'bank.linking.delete.confirm': '削除確認',
    'bank.linking.delete.warning': 'この銀行口座を削除してもよろしいですか？この操作は元に戻せません。',
    'bank.linking.adding': '追加中...',
    'bank.linking.error.fill.required': '必要なフィールドをすべて入力してください',
    'common.success': '成功',
     ...
     'vip.benefits.priority.support.desc': 'カスタマーサービスチームから優先サポートを受ける',
      ...
      'page.title.withdraw': '出金',
       ...
       'page.title.platform.intro': 'プラットフォーム紹介',
        ...
        // Order Rules page
        'order.rules.back': '戻る',
        'order.rules.title': '注文ルール',
        'order.rules.subtitle': 'プラットフォーム運営規則とガイドライン',
        'order.rules.order.title': 'プラットフォーム運営規則',
        'order.rules.order.1': 'このプラットフォームは人工知能システムを採用し、マーチャントと注文取得ユーザーにより便利で迅速なサービスを提供します',
        'order.rules.order.2': 'このプラットフォームは、SPECIAL NOTICEと協力する世界中の10万人以上のeコマースマーチャントにサービスを提供しています。マーチャントは、製品の露出を増やすために、このプラットフォームで製品を表示・販売します。注文取得ユーザーが注文を完了すると、マーチャントは即座に注文金額と手数料を返還します。プラットフォームは注文取得ユーザーにマーチャントまたは注文をランダムにマッチングし、手数料は注文サイズとVIPレベルに関連しています',
        'order.rules.order.3': '注文数はVIPレベルに関連しています。VIPレベルが高いほど、注文数が多く、利益が高くなります',
        'order.rules.order.4': 'プラットフォームシステムは、ユーザーのアカウント残高に基づいてVIPレベルを決定し、注文取得ユーザーのレベルをアップグレード/ダウングレードします',
        'order.rules.payment.title': '注文完了規則',
        'order.rules.payment.1': '注文取得ユーザーは、対応するVIPレベルの注文数量を1日に1回だけ完了できます。注文取得ユーザーは、対応するVIPレベルの注文数量を完了した後でのみ現金を引き出すことができます',
        'order.rules.payment.2': 'その日の注文を完了した後、ユーザーがまだ手数料を稼ぎ続けたい場合は、VIPレベルを上げることを選択できます。または、翌日にシステムが注文をリセットするのを待ちます',
        'order.rules.payment.3': 'ユーザーの注文取得を奨励するため、プラットフォームはラッキー注文を設定しており、ラッキー注文はランダムにマッチングされます',
        'order.rules.payment.4': 'このプラットフォームはメンバーシップ招待システムを採用しています。注文を取得するユーザーは、親戚や友人を注文取得に参加するよう招待できます',
        'order.rules.processing.title': 'プライバシーポリシー',
        'order.rules.processing.1': 'SPECIAL NOTICEプラットフォームは、すべての注文取得ユーザーのプライバシーを尊重し、注文取得ユーザーのプライバシー保護により注意を払っています',
        'order.rules.processing.2': 'すべてのユーザーデータは暗号化され、弊社のサーバーに安全に保存されます',
        'order.rules.processing.3': '明示的な同意なしに、第三者と個人情報を共有することはありません',
        'order.rules.processing.4': 'ユーザーはいつでも個人データの削除を要求する権利があります',
        'order.rules.delivery.title': '最終条項',
        'order.rules.delivery.1': '上記のSPECIAL NOTICEプラットフォームは最終的な解釈権を有します',
        'order.rules.delivery.2': 'ユーザーは規則を遵守するよう求められます',
        'order.rules.delivery.3': 'プラットフォーム規則の違反は、アカウント停止を招く可能性があります',
        'order.rules.delivery.4': 'プラットフォームは、これらの規則をいつでも修正する権利を保有します',
      ...
      // Platform Introduction
      'platform.intro.title': 'Farfetch Limitedについて',
      'platform.intro.paragraph1': 'Farfetch Limitedは、ポルトガルの起業家José Nevesによって2007年にロンドン、イギリスで設立された、高級ファッション専門のグローバルeコマースプラットフォームです。このプラットフォームは2008年に正式にスタートし、現代的でパーソナライズされた便利なデジタルプラットフォームを通じて、独立系ファッションブティックと世界中の顧客を結びつけることを使命としています。',
      'platform.intro.paragraph2': '現在まで、Farfetchは190以上の国と地域で事業を展開し、50以上の国にある約1,300-1,400のブランド、ブティック、高級百貨店と提携しています。このプラットフォームは何千もの高級ファッション製品を提供しながら、先進技術とユーザー行動に基づくパーソナライゼーションを統合した現代的なショッピング体験を提供しています。',
      'platform.intro.paragraph3': 'Farfetchは在庫を持たずに買い手が多様な製品にアクセスできるマーケットプレイスモデルで運営されています。しかし、高い運営コストと最近の財務変動が会社に大きな課題をもたらしています。2023年末、Farfetchは韓国最大のeコマース企業であるCoupangから救済投資を受け、事業を維持し、システムを再構築することとなりました。',
      'platform.intro.paragraph4': '持続可能な成長を促進するため、Farfetchは長期従業員とメンバーに投資、注文配布、および自分のストアフロントを通じて利益を得る機会を提供しています。ストアフロントシステムは小規模から大規模までのVIPレベルに階層化されており、さまざまな規模の投資家がプラットフォームと共に参加し成長することを可能にしています。',
      'platform.intro.us.offices.title': 'アメリカのFarfetchオフィス',
      'platform.intro.los.angeles': 'ロサンゼルス',
      'platform.intro.los.angeles.subtitle': 'ウエストコースト/米国西海岸本社',
      'platform.intro.legal.entity': '法人名',
      'platform.intro.address': '住所',
      'platform.intro.new.york': 'ニューヨーク市',
      'platform.intro.office.location': 'オフィス所在地',
      'platform.intro.near.landmarks': 'ブライアント公園とグランドセントラル駅の近く',
  },
  pt: {
    // Navigation
    'nav.home': 'Início',
    ...
    'vip.benefits.priority.support.desc': 'Obtenha suporte prioritário da equipe de atendimento ao cliente',
     ...
     'page.title.withdraw': 'Sacar',
      ...
      // Order Rules page
      'order.rules.back': 'VOLTAR',
      'order.rules.title': 'TERMOS E REGULAMENTOS',
      'order.rules.subtitle': 'Por favor, leia cuidadosamente as seguintes regras e termos antes de fazer um pedido na Farfetch',
      'order.rules.order.title': 'Regulamentos de Pedido',
      'order.rules.order.1': 'Os clientes devem registrar uma conta e verificar as informações antes de fazer pedidos',
      'order.rules.order.2': 'Cada pedido deve ter um valor mínimo de 100.000 VND',
      'order.rules.order.3': 'As informações do pedido devem ser precisas e completas',
      'order.rules.order.4': 'Produtos proibidos ou restritos não podem ser encomendados',
      'order.rules.payment.title': 'Pagamento',
      'order.rules.payment.1': 'Suporte para pagamento via cartão de crédito, carteira digital e transferência bancária',
      'order.rules.payment.2': 'O pagamento deve ser concluído dentro de 24 horas após fazer o pedido',
      'order.rules.payment.3': 'Os pedidos serão automaticamente cancelados se não forem pagos a tempo',
      'order.rules.payment.4': 'Os reembolsos serão processados dentro de 3-7 dias úteis',
      'order.rules.processing.title': 'Tempo de Processamento',
      'order.rules.processing.1': 'Os pedidos serão confirmados dentro de 2 horas úteis',
      'order.rules.processing.2': 'Tempo de preparação: 1-3 dias úteis',
      'order.rules.processing.3': 'Tempo de entrega: 2-5 dias úteis dependendo da área',
      'order.rules.processing.4': 'Os clientes receberão notificações por email e SMS',
      'order.rules.delivery.title': 'Entrega e Devoluções',
      'order.rules.delivery.1': 'Entrega gratuita para pedidos acima de 500.000 VND',
      'order.rules.delivery.2': 'Devoluções suportadas dentro de 7 dias do recebimento',
      'order.rules.delivery.3': 'Os produtos devolvidos devem estar intactos e não utilizados',
      'order.rules.delivery.4': 'Os custos de envio de devolução serão suportados pelos clientes',
      'order.rules.contact.title': 'CONTATO DE SUPORTE',
      'order.rules.contact.subtitle': 'Se você tiver perguntas sobre as regras de pedido, por favor entre em contato conosco',
      'order.rules.contact.hotline': 'Linha Direta',
      'order.rules.contact.email': 'Email',
      'order.rules.contact.hours': 'Horário de Funcionamento',
      'order.rules.contact.hours.value': '8:00 - 22:00 diariamente',
     'page.title.about.us': 'Sobre Nós',
      'page.title.delivery.info': 'Informações de Entrega',
      'page.title.bank.linking': 'Vinculação Bancária',
      
      // Platform Introduction
      'platform.intro.title': 'Sobre a Farfetch Limited',
      'platform.intro.paragraph1': 'A Farfetch Limited é uma plataforma global de e-commerce especializada em moda de luxo, fundada em 2007 pelo empresário português José Neves em Londres, Reino Unido. A plataforma foi oficialmente lançada em 2008 com a missão de conectar boutiques de moda independentes com clientes em todo o mundo através de uma plataforma digital moderna, personalizada e conveniente.',
      'platform.intro.paragraph2': 'Até hoje, a Farfetch opera em mais de 190 países e territórios, fazendo parceria com aproximadamente 1.300-1.400 marcas, boutiques e lojas de departamento de luxo em mais de 50 países. A plataforma oferece milhares de produtos de moda de luxo, proporcionando uma experiência de compra moderna integrada com tecnologia avançada e personalização baseada no comportamento do usuário.',
      'platform.intro.paragraph3': 'A Farfetch opera em um modelo de marketplace, permitindo que os compradores acessem uma gama diversificada de produtos sem manter estoque. No entanto, altos custos operacionais e flutuações financeiras recentes representaram desafios significativos para a empresa. No final de 2023, a Farfetch recebeu um investimento de resgate da Coupang — a maior corporação de e-commerce da Coreia do Sul — para sustentar as operações e reestruturar seu sistema.',
      'platform.intro.paragraph4': 'Para promover o crescimento sustentável, a Farfetch oferece aos funcionários de longo prazo e membros a oportunidade de investir, distribuir pedidos e ganhar lucros através de suas próprias vitrines. O sistema de vitrine é dividido em níveis VIP, de pequeno a grande, facilitando que investidores de várias escalas participem e cresçam junto com a plataforma.',
      'platform.intro.us.offices.title': 'Escritórios da Farfetch nos Estados Unidos',
      'platform.intro.los.angeles': 'Los Angeles',
      'platform.intro.los.angeles.subtitle': 'Costa Oeste / Sede da Costa Oeste dos EUA',
      'platform.intro.legal.entity': 'Nome da entidade legal',
      'platform.intro.address': 'Endereço',
      'platform.intro.new.york': 'Nova York',
      'platform.intro.office.location': 'Localização do escritório',
      'platform.intro.near.landmarks': 'perto do Bryant Park e Grand Central Terminal',
  ...
  vi: {
    ...
    'profile.delivery.info': 'Thông tin giao hàng',
      ...
      // Bank Linking
      'bank.linking.title': 'Liên kết ngân hàng',
      'bank.linking.add': 'Thêm',
      'bank.linking.add.account': 'Thêm tài khoản ngân hàng',
      'bank.linking.select.bank': 'Chọn ngân hàng',
      'bank.linking.account.number': 'Số tài khoản',
      'bank.linking.account.number.placeholder': 'Nhập số tài khoản',
      'bank.linking.account.holder': 'Chủ tài khoản',
      'bank.linking.account.holder.placeholder': 'Tên chủ tài khoản',
      'bank.linking.branch': 'Chi nhánh',
      'bank.linking.branch.placeholder': 'Nhập chi nhánh (tùy chọn)',
      'bank.linking.add.account.button': 'Thêm tài khoản',
      'bank.linking.cancel': 'Hủy',
      'bank.linking.no.accounts': 'Chưa có tài khoản ngân hàng nào được liên kết',
      'bank.linking.no.accounts.desc': 'Thêm tài khoản ngân hàng đầu tiên để bắt đầu sử dụng dịch vụ rút tiền',
      'bank.linking.add.first': 'Thêm tài khoản đầu tiên',
      'bank.linking.account.details': 'Chi tiết tài khoản',
      'bank.linking.account.added': 'Thêm tài khoản ngân hàng thành công',
      'bank.linking.account.updated': 'Cập nhật tài khoản ngân hàng thành công',
      'bank.linking.account.deleted': 'Xóa tài khoản ngân hàng thành công',
      'bank.linking.delete.confirm': 'Xác nhận xóa',
      'bank.linking.delete.warning': 'Bạn có chắc chắn muốn xóa tài khoản ngân hàng này? Hành động này không thể hoàn tác.',
      'bank.linking.adding': 'Đang thêm...',
      'bank.linking.error.fill.required': 'Vui lòng điền đầy đủ thông tin bắt buộc',
    ...
    'vip.benefits.priority.support.desc': 'Được ưu tiên hỗ trợ từ đội ngũ chăm sóc khách hàng',
     ...
     'page.title.withdraw': 'Rút tiền',
      ...
      // Order Rules page
      'order.rules.back': 'QUAY LẠI',
      'order.rules.title': 'Quy tắc đặt hàng',
      'order.rules.subtitle': 'Quy tắc và hướng dẫn vận hành nền tảng',
      'order.rules.order.title': 'Quy tắc vận hành nền tảng',
      'order.rules.order.1': 'Nền tảng này áp dụng hệ thống trí tuệ nhân tạo để phục vụ các thương gia và người dùng nhận đơn hàng một cách thuận tiện và nhanh chóng hơn',
      'order.rules.order.2': 'Nền tảng này phục vụ hơn 100.000 thương gia thương mại điện tử trên toàn thế giới hợp tác với SPECIAL NOTICE. Các thương gia hiển thị và bán sản phẩm của họ trên nền tảng này để tăng độ phơi bày sản phẩm. Sau khi người dùng nhận đơn hàng hoàn thành đơn hàng, thương gia sẽ ngay lập tức trả lại số tiền đơn hàng và hoa hồng. Nền tảng ngẫu nhiên ghép nối thương gia hoặc đơn hàng cho người dùng nhận đơn hàng, và hoa hồng liên quan đến quy mô đơn hàng và cấp VIP',
      'order.rules.order.3': 'Số lượng đơn hàng liên quan đến cấp VIP. Cấp VIP càng cao, số lượng đơn hàng càng lớn và lợi nhuận càng cao',
      'order.rules.order.4': 'Hệ thống nền tảng sẽ xác định cấp VIP dựa trên số dư tài khoản của người dùng và nâng cấp/hạ cấp mức độ cho người dùng nhận đơn hàng',
      'order.rules.payment.title': 'Quy tắc hoàn thành đơn hàng',
      'order.rules.payment.1': 'Người dùng nhận đơn hàng chỉ có thể hoàn thành số lượng đơn hàng của cấp VIP tương ứng một lần mỗi ngày. Người dùng nhận đơn hàng chỉ có thể rút tiền mặt sau khi hoàn thành số lượng đơn hàng của cấp VIP tương ứng',
      'order.rules.payment.2': 'Sau khi hoàn thành đơn hàng trong ngày, nếu người dùng vẫn muốn tiếp tục kiếm hoa hồng, họ có thể chọn tăng cấp VIP. Hoặc chờ hệ thống đặt lại đơn hàng vào ngày hôm sau',
      'order.rules.payment.3': 'Để khuyến khích người dùng nhận đơn hàng, nền tảng đã thiết lập các đơn hàng may mắn, và các đơn hàng may mắn được ghép nối ngẫu nhiên',
      'order.rules.payment.4': 'Nền tảng này áp dụng hệ thống mời thành viên. Người dùng nhận đơn hàng có thể mời người thân và bạn bè tham gia nhận đơn hàng',
      'order.rules.processing.title': 'Chính sách bảo mật',
      'order.rules.processing.1': 'Nền tảng SPECIAL NOTICE tôn trọng quyền riêng tư của mọi người dùng nhận đơn hàng và chú trọng hơn đến việc bảo vệ quyền riêng tư của người dùng nhận đơn hàng',
      'order.rules.processing.2': 'Tất cả dữ liệu người dùng được mã hóa và lưu trữ an toàn trên máy chủ của chúng tôi',
      'order.rules.processing.3': 'Chúng tôi không chia sẻ thông tin cá nhân với bên thứ ba mà không có sự đồng ý rõ ràng',
      'order.rules.processing.4': 'Người dùng có quyền yêu cầu xóa dữ liệu cá nhân của họ bất cứ lúc nào',
      'order.rules.delivery.title': 'Điều khoản cuối cùng',
      'order.rules.delivery.1': 'Nền tảng SPECIAL NOTICE ở trên có quyền giải thích cuối cùng',
      'order.rules.delivery.2': 'Người dùng được yêu cầu tuân thủ các quy tắc',
      'order.rules.delivery.3': 'Bất kỳ vi phạm quy tắc nền tảng nào có thể dẫn đến tạm ngưng tài khoản',
      'order.rules.delivery.4': 'Nền tảng bảo lưu quyền sửa đổi các quy tắc này bất cứ lúc nào',
     'page.title.about.us': 'Về chúng tôi',
      'page.title.delivery.info': 'Thông tin giao hàng',
      'page.title.bank.linking': 'Liên kết ngân hàng',
      
      // Platform Introduction
      'platform.intro.title': 'Giới thiệu về Farfetch Limited',
      'platform.intro.paragraph1': 'Farfetch Limited là nền tảng thương mại điện tử toàn cầu chuyên về thời trang xa xỉ, được thành lập vào năm 2007 bởi doanh nhân người Bồ Đào Nha José Neves tại London, Anh. Nền tảng chính thức đi vào hoạt động từ năm 2008, với sứ mệnh kết nối các boutique thời trang độc lập với khách hàng toàn cầu thông qua một nền tảng số hiện đại, cá nhân hóa và tiện lợi.',
      'platform.intro.paragraph2': 'Tính đến nay, Farfetch đã có mặt tại hơn 190 quốc gia và vùng lãnh thổ, hợp tác với khoảng 1.300–1.400 thương hiệu, boutique và các cửa hàng bách hóa cao cấp tại hơn 50 quốc gia. Nền tảng này cung cấp hàng nghìn sản phẩm thời trang xa xỉ, đồng thời mang đến trải nghiệm mua sắm hiện đại, tích hợp công nghệ tiên tiến và khả năng tùy biến dựa trên hành vi người dùng.',
      'platform.intro.paragraph3': 'Farfetch hoạt động theo mô hình marketplace (chợ điện tử), cho phép người mua tiếp cận đa dạng nguồn cung mà không cần sở hữu kho hàng. Tuy nhiên, chi phí vận hành cao và những biến động tài chính trong thời gian gần đây đã tạo áp lực lớn lên doanh nghiệp. Đến cuối năm 2023, Farfetch nhận được khoản đầu tư cứu trợ từ Coupang – tập đoàn thương mại điện tử lớn nhất Hàn Quốc – nhằm duy trì hoạt động và tái cấu trúc hệ thống.',
      'platform.intro.paragraph4': 'Để phát triển bền vững, Farfetch còn tạo điều kiện cho các nhân viên lâu năm và thành viên (membership) có cơ hội đầu tư, phân phối đơn hàng và nhận lợi nhuận trên các gian hàng của mình. Hệ thống phân chia gian hàng được thiết kế theo từng cấp độ VIP, từ nhỏ đến lớn, nhằm tạo điều kiện thuận lợi cho các nhà đầu tư với quy mô đa dạng có thể tham gia và phát triển cùng hệ thống.',
      'platform.intro.us.offices.title': 'Văn phòng Farfetch tại Hoa Kỳ',
      'platform.intro.los.angeles': 'Los Angeles',
      'platform.intro.los.angeles.subtitle': 'Văn phòng West Coast / U.S. West Coast HQ',
      'platform.intro.legal.entity': 'Tên công ty pháp lý',
      'platform.intro.address': 'Địa chỉ',
      'platform.intro.new.york': 'New York City',
      'platform.intro.office.location': 'Vị trí văn phòng',
      'platform.intro.near.landmarks': 'gần Bryant Park và Grand Central Terminal',
     ...
     'page.title.vip.levels': 'Cấp độ VIP',
      ...
      'withdrawal.page.title': 'Lịch sử rút tiền',
      'withdrawal.loading': 'Đang tải...',
      'withdrawal.no.transactions': 'Chưa có giao dịch rút tiền nào',
      'withdrawal.amount': 'Rút tiền',
      'withdrawal.status.pending': 'Đang chờ xử lý',
      'withdrawal.status.approved': 'Đã duyệt',
      'withdrawal.status.completed': 'Hoàn thành',
      'withdrawal.status.rejected': 'Bị từ chối',
      'withdrawal.date.created': 'Ngày tạo:',
      'withdrawal.date.processed': 'Ngày xử lý:',
      'withdrawal.notes': 'Ghi chú:',
      'withdrawal.error.load': 'Không thể tải lịch sử rút tiền',
      'support.initial.message': 'Xin chào, tôi cần hỗ trợ!',
      'delivery.page.title': 'Thông tin nhận hàng',
      'delivery.address.title': 'Địa chỉ giao hàng',
      'delivery.full.name': 'Họ và tên',
      'delivery.full.name.placeholder': 'Nhập họ và tên',
      'delivery.phone.number': 'Số điện thoại',
      'delivery.phone.number.placeholder': 'Nhập số điện thoại',
      'delivery.city': 'Tỉnh/Thành phố',
      'delivery.city.placeholder': 'Tỉnh/Thành phố',
      'delivery.district': 'Quận/Huyện',
      'delivery.district.placeholder': 'Quận/Huyện',
      'delivery.ward': 'Phường/Xã',
      'delivery.ward.placeholder': 'Phường/Xã',
      'delivery.address': 'Địa chỉ cụ thể',
      'delivery.address.placeholder': 'Số nhà, tên đường...',
      'delivery.save': 'Lưu thông tin',
      'delivery.saving': 'Đang lưu...',
      'delivery.success': 'Thành công',
      'delivery.success.message': 'Đã lưu thông tin nhận hàng',
      'delivery.error': 'Lỗi',
      'delivery.error.message': 'Không thể lưu thông tin nhận hàng',
      ...
      'auth.login.identifier': 'Email, Tên người dùng hoặc Số điện thoại',
      'auth.login.identifier.placeholder': 'Nhập tên người dùng hoặc số điện thoại',
      'auth.login.identifier.hint': 'Bạn có thể đăng nhập bằng tên người dùng hoặc số điện thoại',
      'auth.signin.failed': 'Đăng nhập thất bại',
      'auth.signin.invalid.credentials': 'Tên người dùng/số điện thoại hoặc mật khẩu không đúng',
      'auth.signin.user.not.found': 'Không tìm thấy người dùng với thông tin này',
      'auth.signin.success': 'Đăng nhập thành công',
      'auth.signin.welcome.back': 'Chào mừng bạn trở lại!',
      'auth.signin.welcome': 'Chào mừng đến với nền tảng!',
      ...
      'auth.signup.success.message': 'Tài khoản đã được tạo thành công! Bạn đã đăng nhập.',
      ...
      'auth.account.locked': 'Tài khoản của bạn đã bị khóa. Vui lòng liên hệ hỗ trợ.',
        ...
        'admin.dashboard.overview': 'Tổng quan bảng điều khiển',
        'admin.welcome.back': 'Chào mừng trở lại,',
        'admin.total.users': 'Tổng số người dùng',
        'admin.registered.users': 'Người dùng đã đăng ký',
        'admin.vip.users': 'Người dùng VIP',
        'admin.special.roles': 'Người dùng có vai trò đặc biệt',
        'admin.total.orders': 'Tổng số đơn hàng',
        'admin.all.time.orders': 'Tất cả đơn hàng',
        'admin.total.revenue': 'Tổng doanh thu',
        'admin.completed.orders': 'Từ đơn hàng đã hoàn thành',
        'admin.net.revenue': 'Nạp tiền - Rút tiền',
        'admin.total.deposits': 'Tổng số tiền nạp',
        'admin.user.deposits': 'Từ tất cả tiền nạp của người dùng',
        'admin.total.withdrawals': 'Tổng số tiền rút',
        'admin.completed.withdrawals': 'Từ các lệnh rút đã hoàn thành',
        'admin.user.management': 'Quản lý người dùng',
        'admin.vip.management': 'Quản lý VIP',
        'admin.product.management': 'Quản lý sản phẩm',
        'admin.add.product': 'Thêm sản phẩm',
        'admin.create.new.product': 'Tạo sản phẩm mới',
        'admin.product.name': 'Tên sản phẩm',
        'admin.product.image': 'Hình ảnh sản phẩm',
        'admin.create.product': 'Tạo sản phẩm',
        'admin.select.vip.level': 'Chọn cấp VIP',
        'admin.withdrawal.management': 'Quản lý rút tiền',
        'admin.deposit.history': 'Lịch sử nạp tiền',
        'admin.search.users': 'Tìm kiếm theo tên, email hoặc số điện thoại...',
        'admin.all.status': 'Tất cả trạng thái',
        'admin.active': 'Hoạt động',
        'admin.locked': 'Bị khóa',
        'admin.all.roles': 'Tất cả vai trò',
        'admin.admin.role': 'Quản trị viên',
        'admin.moderator.role': 'Người điều hành',
        'admin.user.role': 'Người dùng',
        'admin.cards': 'Thẻ',
        'admin.table': 'Bảng',
        ...
        'admin.role': 'Vai trò',
        'admin.vip.level': 'Cấp VIP',
        'admin.total.spent': 'Tổng chi tiêu',
        'admin.balance': 'Số dư',
        'admin.bonus.orders': 'Đơn hàng thưởng',
        'admin.bonus.amount': 'Số tiền thưởng',
        'admin.account.status': 'Trạng thái tài khoản',
        'admin.task.status': 'Trạng thái nhiệm vụ',
        'admin.actions': 'Hành động',
        'admin.edit': 'Chỉnh sửa',
        'admin.edit.user': 'Chỉnh sửa người dùng',
        'admin.save.changes': 'Lưu thay đổi',
        'admin.saving': 'Đang lưu...',
        'admin.cancel': 'Hủy',
        'admin.no.users.found': 'Không tìm thấy người dùng phù hợp với bộ lọc hiện tại',
        'admin.no.username': 'Không có tên người dùng',
        'admin.no.email': 'Không có email',
        'admin.no.phone': 'Không có số điện thoại',
        'admin.users.count': 'Người dùng',
        'admin.user.updated': 'Cập nhật người dùng thành công',
        'admin.user.update.failed': 'Cập nhật người dùng thất bại',
        'admin.role.updated': 'Cập nhật vai trò người dùng thành công',
        'admin.role.update.failed': 'Cập nhật vai trò người dùng thất bại',
        'admin.vip.add.new': 'Thêm cấp mới',
        'admin.level.id': 'ID Cấp độ',
        'admin.image': 'Hình ảnh',
        'admin.level.name': 'Tên cấp độ',
        'admin.min.orders': 'Đơn hàng tối thiểu',
        'admin.min.spent': 'Chi tiêu tối thiểu',
        'admin.commission.rate': 'Tỷ lệ hoa hồng (%)',
        'admin.created.date': 'Ngày tạo',
        'admin.new': 'Mới',
        'admin.add': 'Thêm',
        'admin.bank.info': 'Thông tin ngân hàng',
        'admin.upload.image': 'Tải lên hình ảnh',
        'admin.name': 'Tên',
        'admin.description': 'Mô tả',
        'admin.price': 'Giá',
        'admin.category': 'Danh mục',
        'admin.stock': 'Kho',
        'admin.no.image': 'Không có hình ảnh',
        'admin.no.description': 'Không có mô tả',
        'admin.date': 'Ngày',
        ...
        'admin.status.processing': 'Đang xử lý', 
        'admin.status.cancelled': 'Đã hủy',
       ...
       'task.commission.rate': 'TỶ LỆ HOA HỒNG',
        ...
        'task.button.take.order': 'Nhận đơn hàng',
        
        // User Purchase Management
        'admin.purchase.management': 'Quản lý mua hàng người dùng',
        'admin.purchase.analysis': 'Phân tích và quản lý hoạt động mua hàng của khách hàng',
        'admin.purchase.revenue': 'Tổng doanh thu',
        'admin.purchase.avg.value': 'Giá trị trung bình đơn hàng',
        'admin.per.order': 'mỗi đơn hàng',
        'admin.vip.customers': 'Khách hàng VIP',
        'admin.purchase.customers': 'tổng khách hàng',
        'admin.bestselling.products': 'Sản phẩm bán chạy',
        'admin.products.sold': 'sản phẩm đã bán',
        'admin.customers.tab': 'Khách hàng',
        'admin.top.products': 'Top 10 sản phẩm bán chạy',
        'admin.customer.list': 'Danh sách khách hàng',
        'admin.search.customer': 'Tìm kiếm theo tên, email, số điện thoại...',
        'admin.sort.by': 'Sắp xếp theo',
        'admin.highest.spending': 'Chi tiêu cao nhất',
        'admin.most.orders': 'Nhiều đơn hàng nhất',
        'admin.recent.purchase': 'Mua gần đây nhất',
        'admin.filter.vip': 'Lọc VIP',
        'admin.vip.only': 'Chỉ VIP',
        'admin.regular.customers': 'Khách thường',
        'admin.purchase.orders': 'Tổng đơn hàng',
        'admin.purchase.spending': 'Tổng chi tiêu',
        'admin.average.value': 'Giá trị trung bình',
        'admin.last.purchase': 'Mua gần nhất',
        'admin.purchase.action': 'Thao tác',
        'admin.view.details': 'Xem chi tiết',
        'admin.quantity.sold': 'Số lượng bán',
        'admin.order.count': 'Số đơn hàng',
        'admin.customer.details': 'Chi tiết khách hàng',
        'admin.recent.orders': 'Đơn hàng gần đây',
        'admin.no.orders.yet': 'Chưa có đơn hàng nào',
        'admin.no.customers.found': 'Không tìm thấy khách hàng nào',
        'admin.no.customer.data': 'Chưa có dữ liệu khách hàng',
        
        // Order Management
        'admin.order.management': 'Quản lý đơn hàng',
        'admin.order.overview': 'Xem và quản lý tất cả đơn hàng của khách hàng',
        'admin.pending.orders': 'Đơn hàng chờ xử lý',
        'admin.order.list': 'Danh sách đơn hàng',
        'admin.search.order': 'Tìm kiếm theo ID, sản phẩm, tên khách hàng...',
        'admin.filter.status': 'Lọc theo trạng thái',
        'admin.order.id': 'ID đơn hàng',
        'admin.order.product': 'Sản phẩm',
        'admin.order.quantity': 'Số lượng',
        'admin.order.amount': 'Tổng tiền',
        'admin.order.created': 'Ngày tạo',
        'admin.order.details': 'Chi tiết đơn hàng',
        'admin.order.status': 'Trạng thái đơn hàng',
        'admin.update.status': 'Cập nhật trạng thái',
        'admin.customer.info': 'Thông tin khách hàng',
        'admin.product.info': 'Thông tin sản phẩm',
    ...
    'admin.system.management': 'Quản lý hệ thống',
        ...
        'admin.chat.response.time': 'Thời gian phản hồi TB',
        'admin.chat.minutes': 'phút',
        'admin.chat.open': 'Chat đang mở',
        'admin.chat.list': 'Danh sách chat',
        'admin.filter.chat.status': 'Lọc theo trạng thái',
        'admin.chat.status.open': 'Mở',
        'admin.chat.status.closed': 'Đóng',
        'admin.chat.status.resolved': 'Đã giải quyết',
        'admin.chat.title': 'Tiêu đề chat',
        'admin.chat.last.message': 'Tin nhắn cuối',
        'admin.chat.unread.count': 'Chưa đọc',
        'admin.chat.status': 'Trạng thái',
        'admin.chat.created': 'Tạo',
        'admin.chat.select': 'Chọn một chat để xem tin nhắn',
        'admin.chat.type.message': 'Nhập tin nhắn của bạn...',
        'admin.chat.send': 'Gửi',
        'admin.chat.attach.file': 'Đính kèm tệp',
        'admin.chat.message.sent': 'Gửi tin nhắn thành công',
        'admin.chat.failed.send': 'Gửi tin nhắn thất bại',
        'admin.chat.failed.load.chats': 'Tải danh sách chat thất bại',
        'admin.chat.failed.load.messages': 'Tải tin nhắn thất bại',
        'admin.chat.no.chats.found': 'Không tìm thấy chat nào',
        'admin.chat.no.chats.yet': 'Chưa có chat nào',
  ...
  th: {
    ...
    'page.title.withdraw': 'ถอน',
     ...
     // Order Rules page
      'order.rules.back': 'กลับ',
      'order.rules.title': 'กฎการสั่งซื้อ',
      'order.rules.subtitle': 'กฎการดำเนินงานของแพลตฟอร์มและแนวทาง',
      'order.rules.order.title': 'กฎการดำเนินงานของแพลตฟอร์ม',
      'order.rules.order.1': 'แพลตฟอร์มนี้ใช้ระบบปัญญาประดิษฐ์เพื่อให้บริการแก่ผู้ขายและผู้ใช้รับคำสั่งซื้ออย่างสะดวกและรวดเร็วยิ่งขึ้น',
      'order.rules.order.2': 'แพลตฟอร์มนี้ให้บริการแก่ผู้ค้าออนไลน์มากกว่า 100,000 รายทั่วโลกที่ร่วมมือกับ SPECIAL NOTICE ผู้ค้าแสดงและขายผลิตภัณฑ์ของตนบนแพลตฟอร์มนี้เพื่อเพิ่มการเปิดรับสินค้า หลังจากผู้ใช้รับคำสั่งซื้อทำให้คำสั่งซื้อเสร็จสิ้น ผู้ค้าจะคืนจำนวนเงินคำสั่งซื้อและค่าคอมมิชชั่นทันที แพลตฟอร์มจับคู่ผู้ค้าหรือคำสั่งซื้อแบบสุ่มสำหรับผู้ใช้รับคำสั่งซื้อ และค่าคอมมิชชั่นเกี่ยวข้องกับขนาดคำสั่งซื้อและระดับ VIP',
      'order.rules.order.3': 'จำนวนคำสั่งซื้อเกี่ยวข้องกับระดับ VIP ระดับ VIP ยิ่งสูง จำนวนคำสั่งซื้อยิ่งมาก และกำไรยิ่งสูง',
      'order.rules.order.4': 'ระบบแพลตฟอร์มจะกำหนดระดับ VIP ตามยอดเงินในบัญชีของผู้ใช้และอัปเกรด/ดาวน์เกรดระดับสำหรับผู้ใช้รับคำสั่งซื้อ',
      'order.rules.payment.title': 'กฎการทำให้คำสั่งซื้อเสร็จสิ้น',
      'order.rules.payment.1': 'ผู้ใช้รับคำสั่งซื้อสามารถทำให้จำนวนคำสั่งซื้อของระดับ VIP ที่สอดคล้องกันเสร็จสิ้นได้เพียงครั้งเดียวต่อวัน ผู้ใช้รับคำสั่งซื้อสามารถถอนเงินสดได้หลังจากทำให้จำนวนคำสั่งซื้อของระดับ VIP ที่สอดคล้องกันเสร็จสิ้น',
      'order.rules.payment.2': 'หลังจากทำให้คำสั่งซื้อของวันนั้นเสร็จสิ้น หากผู้ใช้ยังต้องการหาค่าคอมมิชชั่นต่อ สามารถเลือกเพิ่มระดับ VIP หรือรอให้ระบบรีเซ็ตคำสั่งซื้อในวันถัดไป',
      'order.rules.payment.3': 'เพื่อสนับสนุนให้ผู้ใช้รับคำสั่งซื้อ แพลตฟอร์มได้ตั้งคำสั่งซื้อโชคดี และคำสั่งซื้อโชคดีถูกจับคู่แบบสุ่ม',
      'order.rules.payment.4': 'แพลตฟอร์มนี้ใช้ระบบเชิญสมาชิก ผู้ใช้ที่รับคำสั่งซื้อสามารถเชิญญาติและเพื่อนเข้าร่วมการรับคำสั่งซื้อ',
      'order.rules.processing.title': 'นโยบายความเป็นส่วนตัว',
      'order.rules.processing.1': 'แพลตฟอร์ม SPECIAL NOTICE เคารพความเป็นส่วนตัวของผู้ใช้รับคำสั่งซื้อทุกคนและให้ความสำคัญมากขึ้นกับการปกป้องความเป็นส่วนตัวของผู้ใช้รับคำสั่งซื้อ',
      'order.rules.processing.2': 'ข้อมูลผู้ใช้ทั้งหมดได้รับการเข้ารหัสและจัดเก็บอย่างปลอดภัยบนเซิร์ฟเวอร์ของเรา',
      'order.rules.processing.3': 'เราไม่แบ่งปันข้อมูลส่วนบุคคลกับบุคคลที่สามโดยไม่ได้รับความยินยอมอย่างชัดเจน',
      'order.rules.processing.4': 'ผู้ใช้มีสิทธิ์ขอลบข้อมูลส่วนบุคคลของตนเองได้ตลอดเวลา',
      'order.rules.delivery.title': 'ข้อกำหนดสุดท้าย',
      'order.rules.delivery.1': 'แพลตฟอร์ม SPECIAL NOTICE ข้างต้นมีสิทธิ์ในการตีความขั้นสุดท้าย',
      'order.rules.delivery.2': 'ผู้ใช้ถูกขอให้ปฏิบัติตามกฎ',
      'order.rules.delivery.3': 'การละเมิดกฎแพลตฟอร์มใดๆ อาจส่งผลให้บัญชีถูกระงับ',
      'order.rules.delivery.4': 'แพลตฟอร์มสงวนสิทธิ์ในการแก้ไขกฎเหล่านี้ได้ตลอดเวลา',
    'page.title.about.us': 'เกี่ยวกับเรา',
     'page.title.delivery.info': 'ข้อมูลการจัดส่ง',
     'page.title.bank.linking': 'การเชื่อมโยงธนาคาร',
     
     // Platform Introduction
     'platform.intro.title': 'เกี่ยวกับ Farfetch Limited',
     'platform.intro.paragraph1': 'Farfetch Limited เป็นแพลตฟอร์มอีคอมเมิร์ซระดับโลกที่เชี่ยวชาญด้านแฟชั่นหรูหรา ก่อตั้งในปี 2007 โดยนักธุรกิจชาวโปรตุเกส José Neves ในลอนดอน สหราชอาณาจักร แพลตฟอร์มนี้เปิดตัวอย่างเป็นทางการในปี 2008 ด้วยภารกิจในการเชื่อมต่อบูติกแฟชั่นอิสระกับลูกค้าทั่วโลกผ่านแพลตฟอร์มดิจิทัลที่ทันสมัย ส่วนบุคคล และสะดวกสบาย',
     'platform.intro.paragraph2': 'จนถึงปัจจุบัน Farfetch ดำเนินการในกว่า 190 ประเทศและดินแดน ร่วมมือกับแบรนด์ บูติก และห้างสรรพสินค้าหรูหราประมาณ 1,300-1,400 แห่งในกว่า 50 ประเทศ แพลตฟอร์มนี้เสนอผลิตภัณฑ์แฟชั่นหรูหรานับพัน ขณะเดียวกันก็มอบประสบการณ์การช้อปปิ้งที่ทันสมัยซึ่งผสานเทคโนโลยีขั้นสูงและการปรับแต่งเฉพาะบุคคลตามพฤติกรรมผู้ใช้',
     'platform.intro.paragraph3': 'Farfetch ดำเนินงานในรูปแบบมาร์เก็ตเพลส ทำให้ผู้ซื้อสามารถเข้าถึงผลิตภัณฑ์ที่หลากหลายโดยไม่ต้องถือครองสินค้าคงคลัง อย่างไรก็ตาม ต้นทุนการดำเนินงานที่สูงและความผันผวนทางการเงินเมื่อเร็วๆ นี้ได้สร้างความท้าทายที่สำคัญต่อบริษัท ในช่วงปลายปี 2023 Farfetch ได้รับการลงทุนช่วยเหลือจาก Coupang - บริษัทอีคอมเมิร์ซที่ใหญ่ที่สุดของเกาหลีใต้ - เพื่อรักษาการดำเนินงานและปรับโครงสร้างระบบ',
     'platform.intro.paragraph4': 'เพื่อส่งเสริมการเติบโตอย่างยั่งยืน Farfetch ให้โอกาสพนักงานระยะยาวและสมาชิกในการลงทุน กระจายคำสั่งซื้อ และได้รับกำไรผ่านหน้าร้านของตนเอง ระบบหน้าร้านถูกแบ่งเป็นระดับ VIP ตั้งแต่เล็กไปใหญ่ เพื่อให้นักลงทุนขนาดต่างๆ สามารถเข้าร่วมและเติบโตไปพร้อมกับแพลตฟอร์ม',
     'platform.intro.us.offices.title': 'สำนักงาน Farfetch ในสหรัฐอเมริกา',
     'platform.intro.los.angeles': 'ลอสแองเจลิส',
     'platform.intro.los.angeles.subtitle': 'ฝั่งตะวันตก / สำนักงานใหญ่ฝั่งตะวันตกของสหรัฐฯ',
     'platform.intro.legal.entity': 'ชื่อนิติบุคคล',
     'platform.intro.address': 'ที่อยู่',
     'platform.intro.new.york': 'นครนิวยอร์ก',
     'platform.intro.office.location': 'ที่ตั้งสำนักงาน',
     'platform.intro.near.landmarks': 'ใกล้ Bryant Park และ Grand Central Terminal',
    ...
    // Bank Linking  
    'bank.linking.title': 'การเชื่อมโยงธนาคาร',
    'bank.linking.add': 'เพิ่ม',
    'bank.linking.add.account': 'เพิ่มบัญชีธนาคาร',
    'bank.linking.select.bank': 'เลือกธนาคาร',
    'bank.linking.account.number': 'หมายเลขบัญชี',
    'bank.linking.account.number.placeholder': 'กรอกหมายเลขบัญชี',
    'bank.linking.account.holder': 'ชื่อผู้ถือบัญชี',
    'bank.linking.account.holder.placeholder': 'ชื่อผู้ถือบัญชี',
    'bank.linking.branch': 'สาขา',
    'bank.linking.branch.placeholder': 'กรอกสาขา (ไม่บังคับ)',
    'bank.linking.add.account.button': 'เพิ่มบัญชี',
    'bank.linking.cancel': 'ยกเลิก',
    'bank.linking.no.accounts': 'ยังไม่มีบัญชีธนาคารที่เชื่อมโยง',
    'bank.linking.no.accounts.desc': 'เพิ่มบัญชีธนาคารแรกของคุณเพื่อเริ่มใช้บริการถอนเงิน',
    'bank.linking.add.first': 'เพิ่มบัญชีแรก',
    'bank.linking.account.details': 'รายละเอียดบัญชี',
    'bank.linking.account.added': 'เพิ่มบัญชีธนาคารสำเร็จ',
    'bank.linking.account.updated': 'อัปเดตบัญชีธนาคารสำเร็จ',
    'bank.linking.account.deleted': 'ลบบัญชีธนาคารสำเร็จ',
    'bank.linking.delete.confirm': 'ยืนยันการลบ',
    'bank.linking.delete.warning': 'คุณแน่ใจหรือไม่ว่าต้องการลบบัญชีธนาคารนี้? การดำเนินการนี้ไม่สามารถยกเลิกได้',
    'bank.linking.adding': 'กำลังเพิ่ม...',
    'bank.linking.error.fill.required': 'กรุณากรอกข้อมูลที่จำเป็นทั้งหมด',
  ...
  ko: {
    ...
    // Profile page
    'profile.grand.commission': '총 커미션',
    ...
    'page.title.withdraw': '출금',
     ...
     // Order Rules page
      'order.rules.back': '뒤로',
      'order.rules.title': '주문 규칙',
      'order.rules.subtitle': '플랫폼 운영 규칙 및 가이드라인',
      'order.rules.order.title': '플랫폼 운영 규칙',
      'order.rules.order.1': '이 플랫폼은 판매자와 주문 수취 사용자에게 더욱 편리하고 빠른 서비스를 제공하기 위해 인공지능 시스템을 채택합니다',
      'order.rules.order.2': '이 플랫폼은 SPECIAL NOTICE와 협력하는 전 세계 100,000명 이상의 전자상거래 판매자에게 서비스를 제공합니다. 판매자들은 제품 노출을 증가시키기 위해 이 플랫폼에서 제품을 표시하고 판매합니다. 주문 수취 사용자가 주문을 완료하면 판매자는 즉시 주문 금액과 수수료를 반환합니다. 플랫폼은 주문 수취 사용자를 위해 판매자나 주문을 무작위로 매칭하며, 수수료는 주문 크기와 VIP 레벨과 관련이 있습니다',
      'order.rules.order.3': '주문 수는 VIP 레벨과 관련이 있습니다. VIP 레벨이 높을수록 주문 수가 많고 수익이 높습니다',
      'order.rules.order.4': '플랫폼 시스템은 사용자의 계정 잔액을 기준으로 VIP 레벨을 결정하고 주문 수취 사용자의 레벨을 업그레이드/다운그레이드합니다',
      'order.rules.payment.title': '주문 완료 규칙',
      'order.rules.payment.1': '주문 수취 사용자는 해당 VIP 레벨의 주문 수량을 하루에 한 번만 완료할 수 있습니다. 주문 수취 사용자는 해당 VIP 레벨의 주문 수량을 완료한 후에만 현금을 인출할 수 있습니다',
      'order.rules.payment.2': '당일 주문을 완료한 후, 사용자가 여전히 수수료를 계속 벌고 싶다면 VIP 레벨을 높이는 것을 선택할 수 있습니다. 또는 다음 날 시스템이 주문을 재설정할 때까지 기다릴 수 있습니다',
      'order.rules.payment.3': '사용자의 주문 수취를 장려하기 위해 플랫폼은 행운의 주문을 설정했으며, 행운의 주문은 무작위로 매칭됩니다',
      'order.rules.payment.4': '이 플랫폼은 멤버십 초대 시스템을 채택합니다. 주문을 수취하는 사용자는 친척과 친구들을 주문 수취에 참여하도록 초대할 수 있습니다',
      'order.rules.processing.title': '개인정보 보호정책',
      'order.rules.processing.1': 'SPECIAL NOTICE 플랫폼은 모든 주문 수취 사용자의 개인정보를 존중하며 주문 수취 사용자의 개인정보 보호에 더욱 주의를 기울입니다',
      'order.rules.processing.2': '모든 사용자 데이터는 암호화되어 당사 서버에 안전하게 저장됩니다',
      'order.rules.processing.3': '명시적인 동의 없이는 제3자와 개인정보를 공유하지 않습니다',
      'order.rules.processing.4': '사용자는 언제든지 개인 데이터 삭제를 요청할 권리가 있습니다',
      'order.rules.delivery.title': '최종 조항',
      'order.rules.delivery.1': '위 SPECIAL NOTICE 플랫폼은 최종 해석권을 가집니다',
      'order.rules.delivery.2': '사용자는 규칙을 준수하도록 요청됩니다',
      'order.rules.delivery.3': '플랫폼 규칙 위반은 계정 정지로 이어질 수 있습니다',
      'order.rules.delivery.4': '플랫폼은 언제든지 이러한 규칙을 수정할 권리를 보유합니다',
    'page.title.about.us': '회사 소개',
     'page.title.delivery.info': '배송 정보',
     'page.title.bank.linking': '은행 연결',
     
     // Platform Introduction
     'platform.intro.title': 'Farfetch Limited 소개',
     'platform.intro.paragraph1': 'Farfetch Limited는 포르투갈 기업가 José Neves가 2007년 영국 런던에서 설립한 명품 패션 전문 글로벌 이커머스 플랫폼입니다. 이 플랫폼은 2008년에 공식 출시되었으며, 현대적이고 개인화되고 편리한 디지털 플랫폼을 통해 독립 패션 부티크와 전 세계 고객을 연결하는 것을 사명으로 합니다.',
     'platform.intro.paragraph2': '현재까지 Farfetch는 190개 이상의 국가와 지역에서 운영되며, 50개 이상의 국가에 있는 약 1,300-1,400개의 브랜드, 부티크, 럭셔리 백화점과 파트너십을 맺고 있습니다. 이 플랫폼은 수천 개의 럭셔리 패션 제품을 제공하면서 첨단 기술과 사용자 행동 기반 개인화가 통합된 현대적인 쇼핑 경험을 제공합니다.',
     'platform.intro.paragraph3': 'Farfetch는 재고를 보유하지 않고 구매자가 다양한 제품에 액세스할 수 있는 마켓플레이스 모델로 운영됩니다. 그러나 높은 운영 비용과 최근의 재정적 변동이 회사에 상당한 도전을 제기했습니다. 2023년 말, Farfetch는 한국 최대 이커머스 기업인 쿠팡으로부터 구제 투자를 받아 운영을 유지하고 시스템을 재구성하게 되었습니다.',
     'platform.intro.paragraph4': '지속 가능한 성장을 촉진하기 위해, Farfetch는 장기 직원과 회원들에게 자신의 상점을 통해 투자, 주문 분배, 수익 창출의 기회를 제공합니다. 상점 시스템은 소규모에서 대규모까지 VIP 레벨로 계층화되어 다양한 규모의 투자자들이 플랫폼과 함께 참여하고 성장할 수 있도록 합니다.',
     'platform.intro.us.offices.title': '미국 내 Farfetch 사무소',
     'platform.intro.los.angeles': '로스앤젤레스',
     'platform.intro.los.angeles.subtitle': '웨스트 코스트 / 미국 서부 본사',
     'platform.intro.legal.entity': '법인명',
     'platform.intro.address': '주소',
     'platform.intro.new.york': '뉴욕시',
     'platform.intro.office.location': '사무소 위치',
     'platform.intro.near.landmarks': '브라이언트 파크와 그랜드 센트럴 터미널 근처',
