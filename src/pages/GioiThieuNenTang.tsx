      ...
      <div className="max-w-6xl mx-auto p-6 space-y-12">
        ...
        <Card className="shadow-classic border border-border/30">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-playfair tracking-wide">VỀ CHÚNG TÔI</CardTitle>
          </CardHeader>
          
          <CardContent className="space-y-6">
            <p className="font-crimson text-lg leading-relaxed text-center max-w-4xl mx-auto">
              Được thành lập với tầm nhìn trở thành cầu nối giữa những nhà thiết kế tài năng và những người yêu thời trang, 
              Farfetch đã khẳng định vị thế là nền tảng thương mại điện tử thời trang cao cấp đáng tin cậy nhất.
            </p>
            
            <p className="font-crimson text-lg leading-relaxed text-center max-w-4xl mx-auto">
              Chúng tôi tự hào mang đến những bộ sưu tập độc quyền từ các thương hiệu danh tiếng, 
              cùng với trải nghiệm mua sắm đẳng cấp và dịch vụ khách hàng xuất sắc.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <Card key={index} className="shadow-classic border border-border/30 hover:border-primary/30 transition-all duration-300 text-center">
